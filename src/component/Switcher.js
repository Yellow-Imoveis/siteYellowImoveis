...
export default function Switcher() {
    ...
    return (
        <>
            ...
            <a
                onClick={scrollToTop}
                id="back-to-top" className="hidden back-to-top fixed text-lg rounded-full z-10 bottom-5 end-5 h-9 w-9 text-center bg-yellow-500 text-white justify-center items-center flex"><i className="uil uil-arrow-up"></i></a>
            {/* <!-- LTR & RTL Mode Code --> */}

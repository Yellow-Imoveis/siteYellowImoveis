    ...
    />
          ...
          <div className="lg:mt-6">
            <div className="flex justify-start items-center space-x-8">
              <input type="submit" id="search-buy" name="search" className="btn bg-yellow-500 w-full mt-4 lg:w-max lg:mt-0 hover:bg-yellow-600 hover: text-white searchbtn submit-btn cursor-pointer !h-12 rounded-md" value="Buscar" />

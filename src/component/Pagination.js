    ...
    const pageButtons = Array.from({ length: pages }, (_, i) => i + 1).map(
        pageNum => (
            <li>
                <Link 
                    to="#" 
                    className="w-10 h-10 inline-flex justify-center items-center mx-1 rounded-full text-slate-400 bg-white dark:bg-slate-900 hover:text-white shadow-sm dark:shadow-gray-700 hover:border-green-600 dark:hover:border-green-600 hover:bg-yellow-500 dark:hover:bg-yellow-500"
                >
                    {pageNum}
                </Link>
            </li>

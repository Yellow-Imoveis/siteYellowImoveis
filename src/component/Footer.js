                    ...
                    <div className="container text-center">
                        <div className="grid md:grid-cols-2 items-center gap-6">
                            ...
                            <ul className="list-none ltr:md:text-right rtl:md:text-left text-center">
                                ...
                                <li className="inline ms-1"><Link2 to="mailto:contato@yellowimoveis.com.br" className="btn btn-icon btn-sm text-gray-400 hover:text-white border border-gray-800 dark:border-gray-700 rounded-md hover:border-green-600 dark:hover:border-green-600 hover:bg-yellow-500 dark:hover:bg-yellow-500"><Mail className="h-4 w-4"></Mail></Link2></li>
                            </ul>
                        </div>
                    </div>
                </div>
